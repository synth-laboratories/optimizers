...
Proposer credentials are configured in `[proposer]` and launched through
`synth_optimizer_platform::agent_runtime` (run-local `CODEX_HOME`, no silent host fallback).
